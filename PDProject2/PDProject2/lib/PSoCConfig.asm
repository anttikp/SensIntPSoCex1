...
export LoadConfig_pdproject2
export _LoadConfig_pdproject2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pdproject2
	lcall	LoadConfigTBL_pdproject2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pdproject2
;
;    Load configuration registers for pdproject2.
...
;               CUR_PP
;
_LoadConfig_pdproject2:
 LoadConfig_pdproject2:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pdproject2_Bank0
    mov     X, <LoadConfigTBL_pdproject2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pdproject2_Bank1
    mov     X, <LoadConfigTBL_pdproject2_Bank1
